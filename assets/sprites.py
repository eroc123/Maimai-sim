...
class TapNote:
    def __init__(self, speed, button):
        ...
        self.speed = (math.log(self.speed) + 1) * radiusConst * 0.1/20
    def double(self):
    ...
    def update(self):
        x = (self.speed) * buttonpositions(self.button)[0]
        y = (self.speed) * buttonpositions(self.button)[1]
        self.pos[0] += x
        self.pos[1] += y
